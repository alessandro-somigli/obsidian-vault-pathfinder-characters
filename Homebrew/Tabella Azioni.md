...
| **Azione Standard**                                                                                                                                              | **Attacco di Opportunità** |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| Attacco (distanza)                                                                                                                                               | Sì                         |
| Attacco (mischia)                                                                                                                                                | No                         |
| Attacco (senz'armi)                                                                                                                                              | Sì                         |
| Aiutare un altro                                                                                                                                                 | Forse                      |
| Attivare un oggetto magico (escluso pozioni e oli)                                                                                                               | No                         |
| Bere una pozione, applicare un olio o leggere una pergamena                                                                                                      | Sì                         |
| Concentrarsi per tenere attivo un incantesimo                                                                                                                    | No                         |
| [Difesa Totale](https://golarion.altervista.org/wiki/Difesa_Totale "Difesa Totale")                                                                              | No                         |
| [Fintare](https://golarion.altervista.org/wiki/Fintare "Fintare")                                                                                                | No                         |
| Lanciare un incantesimo                                                                                                                                          | Sì                         |
| Liberarsi da una [Lotta](https://golarion.altervista.org/wiki/Lottare "Lottare")                                                                                 | No                         |
| Preparare (attiva un'azione standard)                                                                                                                            | No                         |
| Stabilizzare un amico [Morente](https://golarion.altervista.org/wiki/Morente "Morente") (vedi [Guarire](https://golarion.altervista.org/wiki/Guarire "Guarire")) | Sì                         |
...
| Muoversi + Preparare/Rinfoderare un'arma                                                                                                                                                                                      | No                         |
...
| [Correre](https://golarion.altervista.org/wiki/Azioni_di_Round_Completo#Correre "Azioni di Round Completo") | Sì                         |
| Dare il colpo di grazia                                                                                     | Sì                         |
| Liberarsi da una [Rete](https://golarion.altervista.org/wiki/Armi/Rete "Armi/Rete")                         | Sì                         |
| Prepararsi a lanciare un'arma a spargimento                                                                 | Sì                         |
| [Ritirarsi](https://golarion.altervista.org/wiki/Ritirata "Ritirata")                                       | No                         |
...
L'azione di Round Completo si definisce in questo modo in base alla BAB del personaggio:
#### Bab +0 (1 attacco):
Un personaggio può:
...
- dove si possono comprare? sono disponibili dovunque?
	- medico
	- negozi per avventurieri
	- sono abbondanti nelle città medie/grandi, molto rare altrove
- è possibile costruirle con degli ingredienti? se sì, ritengono l'azione veloce?
...
### Copertura
- Ai fini di stabilire se un bersaglio è sotto copertura contro un attacco a distanza, si traccia una linea retta dal centro del proprio quadretto al centro del bersaglio, se la linea è interrotta da un ostacolo o una creatura il bersaglio ottiene un bonus copertura di +4 alla CA.
### Copertura Totale
- Se non si ha alcuna linea di visuale verso il proprio bersaglio (ovvero se non si può tracciare una linea dal centro del proprio quadretto a un qualsiasi punto nel quadretto del proprio bersaglio), quest’ultimo beneficia di una copertura totale. Non si può portare alcun attacco contro un bersaglio sotto copertura totale.
