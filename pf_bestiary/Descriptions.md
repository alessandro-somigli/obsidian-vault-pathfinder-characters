### Introduzione
Siete stati inviati in un remoto villaggio di Abendall da Cailean per investigare una certa anomalia nell'ecosistema locale.
Chiedendo informazioni nel villaggio siete riusciti a scoprire che la fonte dei problemi si trova dentro un esteso sistema di caverne, e dopo una lunga esplorazione trovate un tunnel recentemente costruito all'interno di uno dei rami più remoti.
